...
* **Embedded Expert:** 精通 **C/C++** 嵌入式开发，从 **ESP32-S3** 穿戴设备到工业级服务器固件。
* **Infrastructure:** 维护多盘位 **NAS** 阵列，深度使用 **Docker** 与 **WSL2** 构建全栈自动化开发环境。
...
### 📂 Focused Projects
* 🔧 **BMC Firmware Customization:** 基于 OpenBMC 的定制化开发。
* 🤖 **AI-Hardware Bridge:** 通过 ESP32-S3 实现的个人 AI 助理终端。
* 🏠 **Home Lab Ops:** 自动化管理 NAS 存储与局域网服务容器化。
